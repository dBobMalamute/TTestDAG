...
class StatisticalTestTemplate : public Idea
{
    ...
    Q_PROPERTY(QColor alphaColor READ alphaColor WRITE setAlphaColor NOTIFY alphaColorChanged)
...
signals:
    ...
    void alphaColorChanged(QColor alphaColor);
...
public slots:
    ...
    void setAlphaColor(QColor alphaColor);
    void cycleAlphaColor();
